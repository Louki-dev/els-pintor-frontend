        ...
        ajaxRequest(data,
            ...
            function (response_data) {
                if (response_data.status == true) {
                    ...
                    Swal.fire({
                        title: 'Success!',
                        text: 'Your order has been received and is now being processed. Thank you!',
                        icon: 'success',
                        confirmButtonText: 'OK',
                        confirmButtonColor: '#2691d9',
                    })
    ...
    function generateProducts($elem, $content, num) {
        ...
        for (var el = 0; el < $content.length; el++) {
            ...
            $html = [
                ...
                '<p class="opacity-75 mt-3 ' + ($content[el].product_status == 1 ? "hid" : "") + '"><input type="number" class="form-control form-control-lg" id="productPieces' + $content[el].product_id + '" placeholder="Quantity" value=""></p>',
    ...
    function generateCalM2Service($elem, $content, num) {
        ...
        for (var el = 0; el < $content.length; el++) {
            ...
            $html = [
                ...
                '<span class="fw-bold opacity-75 mt-1">Estimated Cost:</span><br>',
