    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        ...
        <form class="container">
            <div class="modal-body">
                ...
                <button type="button" class="btn float-end text-muted hover" title="Delete Inquiry" id="deleteRequest">Remove<i class="material-icons fs-6">delete_outline</i></button>
            </div>
