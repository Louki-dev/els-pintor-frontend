...
<html>
    <head>
        ...
        <script src="<?php echo Utilities::domain();?>/js/defined/user.js?v=<?php echo md5(uniqid(rand(), true));?>"></script>
        ...
        <script src="<?php echo Utilities::domain();?>/js/defined/employee-task.js?v=<?php echo md5(uniqid(rand(), true));?>"></script>
