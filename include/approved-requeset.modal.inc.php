    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        ...
        <form>
            <div class="modal-body">
                ...
                <button type="button" class="btn float-end opacity-50 icon hover" title="Copy to Clipboard" id="copyApprovedRequest">Copy<i class="material-icons fs-6">copy_all</i></button>
            </div>
