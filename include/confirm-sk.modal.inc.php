<div class="modal fade" id="sk-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content rounded-4 shadow">
        
        <div class="modal-body p-4 text-center">
        <div class="container">
        <p><h5 class="mb-0">Please enter your secret key to proceed.</h5></p>
        <p class="mb-0"><input type="password" id="sk-admin" class="form-control"></p>
        </div>
