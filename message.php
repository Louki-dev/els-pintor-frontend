                          ...
                          <div class="card rounded-3 mb-4">
                            ...
                            <div class="form-check form-switch ms-3 float-end mt-1">
                              ...
                              <div class="d-grid gap-3 col-11 mx-auto mb-3">
                                <button class="btn pending_header text-white" data-bs-toggle="modal" data-bs-target="#create_message">Create Message</button>
                                </div>
                          </div>
                        <!--------------------------End Contact List------------------------------------------->
                      ...
                      <div class="col-lg-7">
                        ...
                        <div class="d-flex flex-column bg-white rounded-3">
                          <span href="#" class="pending_header text-light rounded-top p-2">
                            ...
                            <div class="dropdown">
                            <a class="btn text-white material-icons float-end fs-6" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                            more_vert
                            </a>
